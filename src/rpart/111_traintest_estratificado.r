...
setwd("~/buckets/b1") # Establezco el Working Directory original X:\\gdrive\\austral2023r\\
...
particionar(dataset, division = c(7, 3), agrupa = "clase_ternaria", seed = 999959) # Cambiar por la primer semilla de cada uno  102191!
